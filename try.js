...
function isAnagram(s, t) {
    ...
    for (let i = 0; i < s.length; i++) {
      let position = s.charCodeAt(i) - "a".charCodeAt(0);
      arr[position] = arr[position] + 1;
    }
    console.log("printing after first str: ", arr);
  
    for (let i = 0; i < t.length; i++) {
      let position = t.charCodeAt(i) - "a".charCodeAt(0);
      arr[position] = arr[position] - 1;
      console.log("printing after second str: ", arr);
